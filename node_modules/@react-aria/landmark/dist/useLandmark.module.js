import {nodeContains as $3xCwh$nodeContains, useLayoutEffect as $3xCwh$useLayoutEffect} from "@react-aria/utils";
...
class $a86207c5d7f7e1fb$var$LandmarkManager {
   ...
   */ f6Handler(e) {
    ...
    focusMain() {
        ...
        if (main && main.ref.current && (0, $3xCwh$nodeContains)(document, main.ref.current)) {
    ...
    navigate(from, backward) {
        ...
        if (nextLandmark.lastFocused) {
            ...
            if ((0, $3xCwh$nodeContains)(document.body, lastFocused)) {
                lastFocused.focus();
                return true;
            }
        }
        // Otherwise, focus the landmark itself
        if (nextLandmark.ref.current && (0, $3xCwh$nodeContains)(document, nextLandmark.ref.current)) {

...
function $ae20dd8cbca75726$export$d6daf82dcd84e87c(options) {
    ...
    let onKeyDown = (e)=>{
        ...
        if (!ref.current || !(0, $3H3GQ$nodeContains)(ref.current, e.target)) return;
            ...
            case 'Tab':
                if (!allowsTabNavigation) {
                    ...
                    if (e.shiftKey) ref.current.focus();
                        ...
                        if (next && (!(0, $3H3GQ$nodeContains)(next, document.activeElement) || document.activeElement && !(0, $3H3GQ$isTabbable)(document.activeElement))) (0, $3H3GQ$focusWithoutScrolling)(next);
                    }
                    break;
                }
        }
    ...
    (0, $3H3GQ$useEvent)(scrollRef, 'scroll', ()=>{
    ...
    let onFocus = (e)=>{
        if (manager.isFocused) {
            ...
            if (!(0, $3H3GQ$nodeContains)(e.currentTarget, e.target)) manager.setFocused(false);
            return;
        }
        // Focus events can bubble through portals. Ignore these events.
        if (!(0, $3H3GQ$nodeContains)(e.currentTarget, e.target)) return;
        ...
        if (manager.focusedKey != null && scrollRef.current) {
            ...
            if (element instanceof HTMLElement) {
                ...
                if (!(0, $3H3GQ$nodeContains)(element, document.activeElement) && !shouldUseVirtualFocus) (0, $3H3GQ$focusWithoutScrolling)(element);
    ...
    let onBlur = (e)=>{
        ...
        if (!(0, $3H3GQ$nodeContains)(e.currentTarget, e.relatedTarget)) manager.setFocused(false);
    };

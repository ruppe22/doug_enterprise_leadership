...
function $b6837c2f80a3c32f$export$d6daf82dcd84e87c(options) {
    ...
    let onKeyDown = (e)=>{
        ...
        if (!ref.current || !(0, $bT8Bh$reactariautils.nodeContains)(ref.current, e.target)) return;
            ...
            case 'Tab':
                if (!allowsTabNavigation) {
                    ...
                    if (e.shiftKey) ref.current.focus();
                        ...
                        if (next && (!(0, $bT8Bh$reactariautils.nodeContains)(next, document.activeElement) || document.activeElement && !(0, $bT8Bh$reactariautils.isTabbable)(document.activeElement))) (0, $bT8Bh$reactariautils.focusWithoutScrolling)(next);
                    }
                    break;
                }
        }
    ...
    (0, $bT8Bh$reactariautils.useEvent)(scrollRef, 'scroll', ()=>{
    ...
    let onFocus = (e)=>{
        if (manager.isFocused) {
            ...
            if (!(0, $bT8Bh$reactariautils.nodeContains)(e.currentTarget, e.target)) manager.setFocused(false);
            return;
        }
        // Focus events can bubble through portals. Ignore these events.
        if (!(0, $bT8Bh$reactariautils.nodeContains)(e.currentTarget, e.target)) return;
        ...
        if (manager.focusedKey != null && scrollRef.current) {
            ...
            if (element instanceof HTMLElement) {
                ...
                if (!(0, $bT8Bh$reactariautils.nodeContains)(element, document.activeElement) && !shouldUseVirtualFocus) (0, $bT8Bh$reactariautils.focusWithoutScrolling)(element);
    ...
    let onBlur = (e)=>{
        ...
        if (!(0, $bT8Bh$reactariautils.nodeContains)(e.currentTarget, e.relatedTarget)) manager.setFocused(false);
    };

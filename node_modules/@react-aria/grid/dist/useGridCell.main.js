...
function $cf2021be63b01ef4$export$c7e10bfc0c59f67c(props, state, ref) {
    ...
    let focus = ()=>{
        if (ref.current) {
            ...
            if (focusMode === 'child') {
                ...
                if ((0, $9yLAi$reactariautils.nodeContains)(ref.current, document.activeElement) && ref.current !== document.activeElement) return;
            ...
            if (keyWhenFocused.current != null && node.key !== keyWhenFocused.current || !(0, $9yLAi$reactariautils.nodeContains)(ref.current, document.activeElement)) (0, $9yLAi$reactariainteractions.focusSafely)(ref.current);
        }
    };
    ...
    let onKeyDownCapture = (e)=>{
        if (!(0, $9yLAi$reactariautils.nodeContains)(e.currentTarget, e.target) || state.isKeyboardNavigationDisabled || !ref.current || !document.activeElement) return;
        ...
        switch(e.key){
            ...
            case 'ArrowDown':
                ...
                if (!e.altKey && (0, $9yLAi$reactariautils.nodeContains)(ref.current, e.target)) {

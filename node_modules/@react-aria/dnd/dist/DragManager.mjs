...
class $67560de7c78cb232$var$DragSession {
    ...
    onKeyUp(e) {
        this.cancelEvent(e);
        if (e.key === 'Enter') {
            if (e.altKey || (0, $irqIb$nodeContains)(this.getCurrentActivateButton(), e.target)) this.activate(this.currentDropTarget, this.currentDropItem);
            else this.drop();
        }
    }
    ...
    onFocus(e) {
        ...
        let dropTarget = this.validDropTargets.find((target)=>target.element === e.target) || this.validDropTargets.find((target)=>(0, $irqIb$nodeContains)(target.element, e.target));
        if (!dropTarget) {
            // if (e.target === activateButton) {
    ...
    onClick(e) {
        ...
        if ((0, $irqIb$isVirtualClick)(e) || this.isVirtualClick) {
            ...
            let item = [
                ...
                return item.element === e.target || (0, $irqIb$nodeContains)((_item_activateButtonRef = item.activateButtonRef) === null || _item_activateButtonRef === void 0 ? void 0 : _item_activateButtonRef.current, e.target);
            });
            let dropTarget = this.validDropTargets.find((target)=>(0, $irqIb$nodeContains)(target.element, e.target));
            ...
            if ((0, $irqIb$nodeContains)(activateButton, e.target) && dropTarget) {

...
import {useLayoutEffect as $6SCDv$useLayoutEffect, nodeContains as $6SCDv$nodeContains, filterDOMProps as $6SCDv$filterDOMProps} from "@react-aria/utils";
...
function $304ac34015d4535d$export$f4bf8d43c16de704(props, state, ref) {
    ...
    let onKeyDown = (e)=>{
        if (!(0, $6SCDv$nodeContains)(e.currentTarget, e.target)) return;
        switch(e.key){
            case 'ArrowRight':
            case 'ArrowDown':
                e.preventDefault();

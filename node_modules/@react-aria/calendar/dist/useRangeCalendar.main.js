...
function $c49ada48cbc48220$export$87e0539f600c24e5(props, state, ref) {
    ...
    let endDragging = (e)=>{
        ...
        let target = e.target;
        if (ref.current && (0, $3kfPe$reactariautils.nodeContains)(ref.current, document.activeElement) && (!(0, $3kfPe$reactariautils.nodeContains)(ref.current, target) || !target.closest('button, [role="button"]'))) state.selectFocusedDate();
    };

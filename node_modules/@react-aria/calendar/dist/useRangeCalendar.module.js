...
import {useEvent as $juhpn$useEvent, nodeContains as $juhpn$nodeContains} from "@react-aria/utils";
...
function $46a4342aab3d8076$export$87e0539f600c24e5(props, state, ref) {
    ...
    let endDragging = (e)=>{
        ...
        let target = e.target;
        if (ref.current && (0, $juhpn$nodeContains)(ref.current, document.activeElement) && (!(0, $juhpn$nodeContains)(ref.current, target) || !target.closest('button, [role="button"]'))) state.selectFocusedDate();
    };

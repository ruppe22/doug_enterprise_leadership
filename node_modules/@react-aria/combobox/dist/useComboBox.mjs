...
function $c350ade66beef0af$export$8c18d1b4f7232bbf(props, state) {
    ...
    let onBlur = (e)=>{
        ...
        let blurIntoPopover = (0, $dShfP$nodeContains)(popoverRef.current, e.relatedTarget);
    ...
    (0, $dShfP$useFormReset)(inputRef, state.defaultSelectedKey, state.setSelectedKey);
